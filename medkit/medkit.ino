...
int box[8][4] =  {0, 2, 3, 4,  // box[i][0]: cột trạng thái đóng-0 mở-1
                  0, 10, 5, 3,  // box[i][1]: cột số lượng sáng  {
                  0, 2, 4, 3,  // box[i][2]: cột số lượng trưa { ba cột số lượng để x10 
                  0, 3, 5, 4,  // box[i][3]: cột số lượng tối   {
                  0, 4, 3, 5,
                  0, 4, 5, 6,
                  0, 6, 4, 6,
                  0, 4, 5, 6};
